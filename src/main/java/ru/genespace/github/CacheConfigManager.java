...
public class CacheConfigManager {
    ...
    private static GitHub getGitHubClientFromInstallationId(String appId, String privateKeyFile, long installationId) throws GeneralSecurityException, IOException {
        //TODO: fix
        //Problem - class InstallationIDAuthorizationProvider does not exist in org.kohsuke.github.extras.authorization
        ...
        //        return GitHubManager.getBuilder(Long.toString(installationId)).withAuthorizationProvider(installationIDAuthorizationProvider).build();
        return null;
    }

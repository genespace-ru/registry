...
public class EntryTypeMetadata {
    ...
    public static final EntryTypeMetadata WORKFLOW =
            new EntryTypeMetadata( EntryType.WORKFLOW, "workflow", "workflows", "workflows", true, WORKFLOW_PREFIX + "/" );
    public static final EntryTypeMetadata SERVICE =
            new EntryTypeMetadata( EntryType.SERVICE, "service", "services", "services", true, SERVICE_PREFIX + "/" );
    ...
    public static final EntryTypeMetadata NOTEBOOK =
            new EntryTypeMetadata( EntryType.NOTEBOOK, "notebook", "notebooks", "notebooks", true, NOTEBOOK_PREFIX + "/" );

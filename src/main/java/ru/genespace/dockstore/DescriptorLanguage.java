...
import static ru.genespace.dockstore.EntryType.NOTEBOOK;
import static ru.genespace.dockstore.EntryType.TOOL;
import static ru.genespace.dockstore.EntryType.WORKFLOW;
import static ru.genespace.dockstore.EntryType.APPTOOL;
...
public enum DescriptorLanguage {
    ...
    public enum FileType {
        ...
        SMK_TEST_PARAMS(FileTypeCategory.TEST_FILE),
        DOCKSTORE_CWL(FileTypeCategory.GENERIC_DESCRIPTOR), 
        CWL_TEST_JSON(FileTypeCategory.TEST_FILE),
        DOCKSTORE_WDL(FileTypeCategory.GENERIC_DESCRIPTOR), 
        WDL_TEST_JSON(FileTypeCategory.TEST_FILE),

        DOCKSTORE_WORKFLOW_OTHER(FileTypeCategory.OTHER),
        DOCKERFILE(FileTypeCategory.CONTAINERFILE),
        NEXTFLOW(FileTypeCategory.GENERIC_DESCRIPTOR), 
        NEXTFLOW_CONFIG(FileTypeCategory.PRIMARY_DESCRIPTOR), 
        NEXTFLOW_TEST_PARAMS(FileTypeCategory.TEST_FILE),
        DOCKSTORE_YML(FileTypeCategory.OTHER),
        DOCKSTORE_SERVICE_YML(FileTypeCategory.PRIMARY_DESCRIPTOR), 
        DOCKSTORE_SERVICE_TEST_JSON(FileTypeCategory.TEST_FILE), 
        DOCKSTORE_SERVICE_OTHER(FileTypeCategory.OTHER),
        DOCKSTORE_GXFORMAT2(FileTypeCategory.GENERIC_DESCRIPTOR), 
        GXFORMAT2_TEST_FILE(FileTypeCategory.TEST_FILE),
        DOCKSTORE_SWL(FileTypeCategory.GENERIC_DESCRIPTOR), 
        SWL_TEST_JSON(FileTypeCategory.TEST_FILE),
        DOCKSTORE_JUPYTER(FileTypeCategory.PRIMARY_DESCRIPTOR), 
        DOCKSTORE_NOTEBOOK_REES(FileTypeCategory.CONFIGURATION_FILE), 
        DOCKSTORE_NOTEBOOK_DEVCONTAINER(FileTypeCategory.CONFIGURATION_FILE), 
        DOCKSTORE_NOTEBOOK_TEST_FILE(FileTypeCategory.TEST_FILE), 
        DOCKSTORE_NOTEBOOK_OTHER(FileTypeCategory.OTHER);
        // DOCKSTORE-2428 - demo how to add new workflow language
